...
2017-01-31, V4.4.0
Release date:
•Available on develop branch at the end of January 2017.
•The implementation will be checked for compliance as soon as the compliance tests of LoRaWAN Specification v1.0.2 are available. When the stack passed all tests, we merge the develop branch into the master branch.

Contents:
•Update to LoRaWAN Specification v1.0.2.
•Implementation of Chinese 470-510MHz band.
•Implementation of Australian 915-928MHz band.
•Implementation of AS 923MHz band.
•Implementation of South Korea 920-923MHz band.

Status:
•In progress.
•Implementation of Chinese 470-510MHz band available on develop branch.
...
* General
    ...
    5. Addition of MoteII platform based on the IMST module iM881A (STM32L051C8)
    6. Addition of NAMote72 platform
    7. Correct compliance test protocol command 0x06 behaviour
    8. Added TxCw (Tx continuous wave) LoRaWAN compliance protocol command.
    9. Added TxContinuousWave support to the radio drivers.
    10. Updated ST HAL drivers.
